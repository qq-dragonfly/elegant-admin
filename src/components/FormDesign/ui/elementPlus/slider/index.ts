  ...
  config: {
    attribute: [
      ...
      },
      {
        ...
        onChange: ({ value, values, componentAttributes }: any) => {
          const componentIndex = componentAttributes.value.findIndex(
            (item: { field: string }) => item.field === 'componentProps.max',
          )
      ...
      },
      {
        ...
        onChange: ({ value, values, componentAttributes }: any) => {
          const componentIndex = componentAttributes.value.findIndex(
            (item: { field: string }) => item.field === 'componentProps.min',
          )
          const componentConfig = componentAttributes.value[componentIndex]
          componentConfig.componentProps = {
            max: value,
      ...
      },
      {
        ...
        onChange: ({ value, values }: any) => {
          if (value) {
            ...
            clonedValues.componentProps.showInputControls = true
          }
        },
      },
      {
        ...
        show: ({ values }: any) => values.componentProps.showInput,
      },
      {
        label: '提示框位置',
        type: 'select',
