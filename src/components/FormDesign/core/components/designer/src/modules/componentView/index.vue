...
import { findSchemaInfoById, generateNewSchema, pluginManager, revoke } from '../../../../../../utils'
  ...
  <div class="elegant-component-view flex flex-col">
    <div class="flex flex-1 overflow-auto">
      ...
      <div class="box-border h-full flex-1 overflow-auto py-2">
        <!-- 搜素框 start -->
        <div class="elegant-search-box px-10px pb-6px">
        ...
        >
          <template #item="{ element }">
            <div class="elegant-componet-item flex items-center truncate" @click="handleClick(element)">
