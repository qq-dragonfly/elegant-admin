...
import { inject, nextTick, onMounted, ref, shallowRef, unref, watch } from 'vue'
import { debounce, useElementDrag, useElementZoom, useShareStore } from '../../../../../../utils'
...
useResizeObserver(editScreenContainerRef, ([{ contentRect }]) => {
  ...
  contentRectWidth = contentRect.width - 40
  contentRectHeight = contentRect.height - 40
...
<template>
  <div class="relative h-full flex flex-col">
    ...
    <div
      ref="editScreenContainerRef" class="elegant-edit-screen-container flex-1 overflow-auto overflow-y-hidden"
    ...
    <div ref="sizeBoxRef" class="pointer-events-none absolute op-0" :style="sizeBoxStyle" />
  </div>
</template>
