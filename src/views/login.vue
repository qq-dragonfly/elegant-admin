    ...
    <div id="login-box">
      ...
      >
        ...
        <div>
          ...
          <el-form-item prop="password">
            <el-input
              ref="registerPasswordRef" v-model="registerForm.password" :type="passwordType" placeholder="密码"
          ...
          <el-form-item prop="checkPassword">
            <el-input
              ref="registerCheckPasswordRef" v-model="registerForm.checkPassword" :type="passwordType"
              placeholder="确认密码" tabindex="4" autocomplete="on"
            >
              <template #prefix>
                <el-icon>
                  <svg-icon name="ep:lock" />
      ...
      >
        ...
        <div>
          ...
          <el-form-item prop="newPassword">
            <el-input
              ref="resetNewPasswordRef" v-model="resetForm.newPassword" :type="passwordType"
              placeholder="新密码" tabindex="3" autocomplete="on"
            >
              <template #prefix>
                <el-icon>
                  <svg-icon name="ep:lock" />
