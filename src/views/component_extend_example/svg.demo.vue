		...
		<page-main>
			...
			<div>
				...
				<el-radio-group v-model="flip">
					...
					<el-radio-button label="horizontal"> 水平翻转 </el-radio-button>
					<el-radio-button label="vertical"> 垂直翻转 </el-radio-button>
					<el-radio-button label="both"> 水平垂直翻转 </el-radio-button>
				</el-radio-group>
				<p>旋转：</p>
