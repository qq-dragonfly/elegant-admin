...
const images = ref(['https://picsum.photos/400', 'https://picsum.photos/600', 'https://picsum.photos/500']);
const files = ref([
	{
		name: '测试文件.zip',
	...
	<div>
		<page-header title="上传">
			<template #content>
				...
				<p style="margin-bottom: 0">由于线上演示环境开启了 Mock ，会导致上传功能报错，请在本地运行并查看演示</p>
			</template>
		</page-header>
